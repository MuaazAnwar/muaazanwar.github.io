    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Professional Experience</h1>
                ...
                <Card className="p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-border">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <span className="skill-badge">Rego</span>
                ...
                <Card className="p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-border">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <span className="skill-badge">Windows Service</span>
                      <span className="skill-badge">Angular JS</span>
